...
(defc AppRoot < rum/cursored-watch [state]
          (view {:style {:flexDirection "column" :margin 40 :alignItems "center"}}
                (text {:style {:fontSize 30 :fontWeight "100" :marginBottom 20 :textAlign "center"}} "Hello Minisha")
...
(defn init []
      (mount-app)
      (.registerComponent app-registry "BaguetteTv" (fn [] root-component-factory)))
